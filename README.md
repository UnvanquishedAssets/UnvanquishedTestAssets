...
- [`map-test-dlight_src.dpkdir`](pkg/map-test-dlight_src.dpkdir)  
  A map to test dynamic light, also features a nice train demo.
- [`map-test-doors_src.dpkdir`](pkg/map-test-doors_src.dpkdir)  
  A map to test various door arrangements (has its' own dedicated [`README`](pkg/map-test-doors_src.dpkdir/README))
- [`map-test-ent-damage_src.dpkdir`](pkg/map-test-ent-damage_src.dpkdir)  
  A map to test support for damage entities (doors, buttons) and triggers heal, hurt.
- [`map-test-gravity0_src.dpkdir`](pkg/map-test-gravity0_src.dpkdir)  
  A map to test that gravity 0 brushes work.
- [`map-test-model_src.dpkdir`](pkg/map-test-model_src.dpkdir)  
  A map to help testing models: replace the armoury model, load the map and check if everything is right.
- [`map-test-navmesh_src.dpkdir`](pkg/map-test-navmesh_src.dpkdir)
...
- [`map-test-normal_src.dpkdir`](pkg/map-test-normal_src.dpkdir)  
